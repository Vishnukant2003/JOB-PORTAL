...
const Working = () => {
    return (
        <div className="mt-20 pb-5 overflow-hidden">
            ...
            <div data-aos="zoom-out" className="text-lg mb-10 sm-mx:text-base xs-mx:text-sm mx-auto text-mine-shaft-300 text-center w-1/2 sm-mx:w-11/12">
            ...
            <div className="flex flex-wrap justify-center items-center gap-10 px-10">
                ...
                <div data-aos="fade-right" className="relative">
                    <img className="w-[30rem] max-w-full" src="/Working/Girl.png" alt="girl" />
                ...
                {/* Right Side: Work Steps */}
                <div data-aos="fade-left" className="flex flex-col gap-10 max-w-[600px] w-full">
                    {
                        work.map((item, index) => (
