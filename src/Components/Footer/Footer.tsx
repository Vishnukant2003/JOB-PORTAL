...
const Footer = () => {
    ...
    <div data-aos="flip-left"  data-aos-offset="0" className="font-medium text-center p-5">
        Designed & Developed By <a className="text-bright-sun-400 hover:underline font-semibold " href="https://github.com/Vishnukant2003/JOB-PORTAL-.git">Vishnukant,Motiram, Samrudhi & Sapna </a>
    </div>
    </div>:<>
    </>
}
