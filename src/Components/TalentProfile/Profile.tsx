    ...
    return <div data-aos="zoom-out" className="w-2/3 lg-mx:w-full">
        <div className="" >
            ...
            <div className="px-3 mt-16">
                <div className="text-3xl xs-mx:text-2xl font-semibold flex justify-between">{profile?.name} <Button size={matches?"sm":"md"} color="brightSun.4" variant="light">Contact</Button></div>
