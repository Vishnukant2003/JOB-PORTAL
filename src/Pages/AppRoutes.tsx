...
import Home1 from '../Components/Resume/templates/Home';
  ...
  return <BrowserRouter>
    <div className='relative overflow-hidden'>
      ...
      <Routes>
        ...
        <Route path="/resume-builder" element={<ProtectedRoute allowedRoles={['APPLICANT', 'ADMIN', 'EMPLOYER']}><ResumeLanding/></ProtectedRoute>} />
        <Route path="/home1" element={<ProtectedRoute allowedRoles={['APPLICANT', 'ADMIN', 'EMPLOYER']}><Home1/></ProtectedRoute>} />
